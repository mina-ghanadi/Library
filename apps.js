...
function firstchapterDisplay(event){
    ...
    let first=document.querySelector("#book");
    console.log(h1.classList.contains("firt-book-letter"));
    console.log(h1.classList);
    if (h1.classList.contains("firt-book-letter") ){}
    first.classList.toggle("display");
    let second=document.querySelector("#book");
